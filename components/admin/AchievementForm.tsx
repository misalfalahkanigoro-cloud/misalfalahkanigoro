...
import { Save, Trash2, Sparkles, AlertCircle, CheckCircle2, ChevronLeft, ExternalLink, RefreshCcw, Award } from 'lucide-react';
...
const AchievementForm: React.FC<AchievementFormProps> = ({
    ...
    useEffect(() => {
        if (achievement) {
            setFormData({
                ...achievement,
                achievedAt: achievement.achievedAt ? achievement.achievedAt.split('T')[0] : '',
            });
        } else {
            setFormData({
                title: '',
    ...
    const handleDelete = async () => {
        ...
        try {
            const res = await fetch(`/api/admin/achievements/${formData.id}`, {
                method: 'DELETE',
            });
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                            ...
                            {formData.id ? 'Edit Prestasi' : 'Prestasi Baru'}
                        </h2>
                        {formData.id && (
                            <div className="flex items-center gap-2">
                                <a
                                    href={`/prestasi/${formData.slug}`}
                                    target="_blank"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 space-y-6">
                        <section className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Judul Prestasi</label>
                                <input
                                    type="text"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    placeholder="judul-prestasi-anda"
                            ...
                            <div className="space-y-3">
                                {formData.coverUrl ? (
                                    ...
                                    <div className="aspect-video rounded-xl border-2 border-dashed border-gray-300 dark:border-white/10 flex flex-col items-center justify-center text-gray-400 bg-white dark:bg-black/20">
                                        ...
                                        <p className="text-[10px] mt-2 font-medium">Belum ada foto utama</p>
                                    </div>
                                )}
